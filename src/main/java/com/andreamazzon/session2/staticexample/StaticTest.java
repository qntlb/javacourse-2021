 ...
 * constructing objects of type StaticExample. Main things to note: - static
 * methods can be called also by writing NameOfClass.nameOfMethod - static
 * fields are stored in one just piece of memory: once they are modified, their
