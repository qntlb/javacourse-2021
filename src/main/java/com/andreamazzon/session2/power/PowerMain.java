...
public class PowerMain {
	...
	public static void main(String[] args) {
		...
		powerCalculator.computeAndPrintPower(base, intExponent);// everything fine: the arguments are double, int
		// the arguments are now double, double: the result can be a complex number
		powerCalculator.computeAndPrintPower(base, doubleExponent);
	}
}
