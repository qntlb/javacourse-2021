...
public class Access {
	...
	/*
	 * no access modifier: can be accessed only from inside the package. Look what happens when we try to
	 * access this field from com.andreamazzon.session3.otherpackage.AccessTestOutside
	 */
	...
	/*
	 * no access modifier: it can be called only from inside the package. Look what happens when we try to call
	 * this method from com.andreamazzon.session3.otherpackage.AccessTestOutside.
	 */
