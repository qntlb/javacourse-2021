...
/**
 * This class illustrates an example of encapsulation. We imagine that a client
 * gives us a distance that he/she traveled and the time needed to travel that
 * distance, and we have to give back the average speed. Suppose that our first
 * version had everything in km, but that for some reasons we have now to pass
 * to miles. However, we don't want that our client has to change the code.
...
public class TravelSpeed {
	 ...
	 * soon as you can. For example: now we express time in minutes, but maybe in a
	...
	// we want the user to be able to give us a new distance as well
	/**
