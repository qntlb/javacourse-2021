 ...
 * Note: if at least one method of the class is abstract then the class must be declared abstract
 * too. Of course the non abstract method can be overridden as well by inheriting classes.
 */
