 ...
 * sense, because there are no already implemented methods leading to possible clashes. We see that a class implementing
 * an interface which extends two interfaces must implement:
