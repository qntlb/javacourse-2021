...
public enum Note {
	 ...
	 * types. They are implicitly public, static, final. Static and final means
	 * constants, and that's why they are capitalized: by a Java convention, static
	 * final fields are capitelized.
	 */
