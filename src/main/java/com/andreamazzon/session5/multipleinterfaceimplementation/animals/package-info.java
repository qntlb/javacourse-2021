 ...
 * swim()). Remember that multiple inheritance is not possible with classes, because the parent classes
 * might have methods with same name and same argument lists implemented in different ways. Here we have
 * not this problem because interfaces are a kind of "full abstract classes", so no implmentation is
