...
/**
 * This class has a method public void foo(), so same name and same argument
 ...
 * FirstParentClass. Here it gets initialized according to a value passed to the
 * constructor, whereas in FirstParentClass it is 1. This possibility of having
 * conflicts is the main reason why multiple inheritance is not permitted in
 * Java.
 *
