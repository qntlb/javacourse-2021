...
/**
 * This class illustrates an use of late binding: the method nextShape() returns an object of type Shape, but
 * actually we return a Circle, a Square or a Triangle. This is possible because a Shape reference is 
 * automatically given to our objects once we create and return them.
 *
