...
/**
 * This class will be extended by MorePowerfulWarrior. It has three methods, damage(Warrior warrior)
 * and move(double x, double y). Note that the method damage(Warrior warrior will be overridden (because more
 * damages and caused) and also overloaded. All the other methods will be just inherited.
 *
...
public class Warrior {
	 ...
	 * same for all objects of type Warrior and it must not change during the game. Note that it could 
	 * also be package access in this specific example, but this is done to stress the fact that it's
	 * protected because we want it to be accessed from a class which extends this class.
	 */
	...
	/*
	 * It is protected because it can also been accessed from MorePowerfulWarrior. Note that it could
	 * also be package access in this specific example, but this is done to stress the fact that it's
	 * protected because we want it to be accessed from a class which extends this class.
	 */
