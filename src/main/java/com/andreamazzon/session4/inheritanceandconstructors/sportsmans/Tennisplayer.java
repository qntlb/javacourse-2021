 ...
 * Sportsman and the commenting out super(name). Note that a tennis player IS a
 * sportsman. This is a very simple example of inheritance.
 *
...
public class Tennisplayer extends Sportsman {
	...
	/*
	 * A tennis player does not have a team. So we don't call the constructor with
	 * team.
	 */
}
