 ...
 * class Inner. Here we see how private fields of the outer class can be accessed from the inner class,
 * and vice versa. An inner class can access fields of the outer class because an object of the inner class
 * must keep a reference to the particular object of the enclosing class that was responsible for creating it.
