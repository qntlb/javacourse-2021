...
/**
 * This is a public access class which has one private field and a private inner
 * class, implementing the interface Printer. The field is accessed are accessed
 * by the inner class. An object of the private inner class, attached to a
 * reference of Printer, is returned by the getAPrinter() method.
 *
