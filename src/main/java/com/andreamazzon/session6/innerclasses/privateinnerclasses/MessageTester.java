 ...
 * class. Note that once you create such an object you have to attach it to a
 * reference of the interface. This hides everything from outside the class.
 *
...
public class MessageTester {
	...
	public static void main(String[] args) {
		 ...
		 * create an object of its type only using the getter method of the outer class
