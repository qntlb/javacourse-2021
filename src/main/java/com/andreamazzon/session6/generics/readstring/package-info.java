 ...
 * generics. The class CharactersOfString here and the class FibonacciSequence
 ...
 * defined in GenericPointer returns a Character in this case and an Integer in
 * FibonacciSequence. So it made sense to avoid to set the return type in the
