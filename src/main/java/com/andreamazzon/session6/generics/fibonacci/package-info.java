 ...
 * generics. The class Fibonacci here and the class CharactersOfString in the
 * package above both implement the interface GenericPointer defined in
 * com.andreamazzon.session6.generics.genericinterfaces. The method next()
 * defined in GenericPointer returns an Integer in this case and a Character in
 * CharactersOfString. So it made sense to avoid to set the return type in the
