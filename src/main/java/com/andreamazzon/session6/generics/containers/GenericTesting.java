...
/**
 * This class has a main method which tests generics: you can see that you can
 * construct different objects of type GenericClass, giving them different
 * types. However, and here is the difference with using Object, once you have
 * created an object of type GenericClass you cannot set its field A to be of
 * different types.
 *
...
public class GenericTesting {
	...
	public static void main(String[] args) {
		 ...
		 * heap. It also provides some methods and fields (for example
		 * Double.MAX_VALUE). Generics only accept wrapper classes.
		 */
		...
		// you cannot set A to be of another type!
		// aDoubleContainer.setField("string");

		System.out.println();
		/*
		 * You specify ComplexNumber in angle brackets, and then you call the
